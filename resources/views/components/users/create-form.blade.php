...
<form action="{{ route('users.store') }}" method="post">
    ...
    <div class='w-full md:w-full'>
        ...
        <div class="px-3 mb-6">
            ...
            <input name="email" class='appearance-none block w-full bg-white text-gray-700 border border-gray-400 shadow-inner rounded-md py-3 px-4 leading-tight focus:outline-none  focus:border-gray-500
                @error(' email') border-red-500 @enderror' id='grid-text-1' type='text' required>
        ...
        <div class="px-3 mb-6">
            <label class='block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2'
                for='grid-text-1'>{{ __('permissions.role') }}</label>
    ...
    <div class="flex justify-end">
        <button class="appearance-none bg-gray-700 text-white p-2 rounded mr-3" type="submit">
            {{ __('permissions.submit') }}
        </button>
    </div>
</form>
